//服务层
app.service('brandStatusService',function($http){
	...
	this.dele=function(ids){
		return $http.get('../brandStatus/delete.do?ids='+ids);
	}
	//搜索
	this.search=function(page,rows,searchEntity){
		return $http.post('../brandStatus/search.do?page='+page+"&rows="+rows, searchEntity);
	}    
